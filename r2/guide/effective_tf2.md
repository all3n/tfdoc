...
in TF 2.0. Some of the major changes include removing <a href="../../api_docs/python/tf/app.md"><code>tf.app</code></a>, <a href="../../api_docs/python/tf/flags.md"><code>tf.flags</code></a>, and
