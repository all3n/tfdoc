...
If `x < y`, the <a href="../../../api_docs/python/tf/math/add.md"><code>tf.add</code></a> operation will be executed and <a href="../../../api_docs/python/tf/math/square.md"><code>tf.square</code></a>
