...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/python/eager/function.py#L2187-L2526">
...
# allowing you to compile the `call` methods of <a href="../../../../../api_docs/python/tf/keras/layers/Layer.md"><code>tf.keras.layers.Layer</code></a> and
# <a href="../../../../../api_docs/python/tf/keras/models/Model.md"><code>tf.keras.Model</code></a> objects.
...
For more information see <a href="../../../tf/autograph"><code>tf.autograph</code></a>.
...
* <b>`input_signature`</b>: A possibly nested sequence of
  <a href="../../../tf/TensorSpec"><code>tf.contrib.eager.TensorSpec</code></a> objects specifying the shapes and dtypes of
...
* <b>`TypeError`</b>: If `input_signature` is neither `None` nor a sequence of
  <a href="../../../tf/TensorSpec"><code>tf.contrib.eager.TensorSpec</code></a> objects.
