...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/bijectors/masked_autoregressive.py#L46-L306">
...
In the <a href="/probability/api_docs/python/tfp"><code>tfp</code></a> framework, a "normalizing flow" is implemented as a
<a href="/probability/api_docs/python/tfp/bijectors/Bijector"><code>tfp.bijectors.Bijector</code></a>. The `forward` "autoregression"
...
roll-out your own, or use some other architecture, e.g., using <a href="../../../../tf/layers"><code>tf.layers</code></a>.
...
x = maf.sample()  # Expensive; uses <a href="../../../../../../api_docs/python/tf/while_loop.md"><code>tf.while_loop</code></a>, no Bijector caching.
maf.log_prob(x)   # Almost free; uses Bijector caching.
maf.log_prob(0.)  # Cheap; no <a href="../../../../../../api_docs/python/tf/while_loop.md"><code>tf.while_loop</code></a> despite no Bijector caching.
...
x = iaf.sample()  # Cheap; no <a href="../../../../../../api_docs/python/tf/while_loop.md"><code>tf.while_loop</code></a> despite no Bijector caching.
iaf.log_prob(x)   # Almost free; uses Bijector caching.
iaf.log_prob(0.)  # Expensive; uses <a href="../../../../../../api_docs/python/tf/while_loop.md"><code>tf.while_loop</code></a>, no Bijector caching.
...
<a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/contrib/distributions/python/ops/bijectors/masked_autoregressive.py#L191-L236">View source</a>
...
* <b>`shift_and_log_scale_fn`</b>: Python `callable` which computes `shift` and
  ...
  <a href="../../../../tf/make_template"><code>tf.compat.v1.make_template</code></a>. Returning `None` for either (both)
...
* <b>`unroll_loop`</b>: Python `bool` indicating whether the <a href="../../../../tf/while_loop"><code>tf.while_loop</code></a> in
