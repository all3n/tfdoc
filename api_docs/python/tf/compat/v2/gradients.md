...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r1.15/tensorflow/python/ops/gradients_impl.py#L162-L274">
...
using the `'zero'` option. <a href="../../../../../api_docs/python/tf/UnconnectedGradients.md"><code>tf.UnconnectedGradients</code></a> provides the
