...
demonstrates how to create a custom <a href="../api_docs/python/tf/estimator/Estimator.md"><code>tf.estimator.Estimator</code></a> that
mimics the behavior of the pre-made Estimator
<a href="../api_docs/python/tf/estimator/DNNClassifier.md"><code>tf.estimator.DNNClassifier</code></a> in solving the Iris problem. See
...
<a href="../api_docs/python/tf/estimator/Estimator.md"><code>tf.estimator.Estimator</code></a> base class, while custom Estimators are an instance
...
model. This configuration step is similar to how we configured the <a href="../api_docs/python/tf/estimator/DNNClassifier.md"><code>tf.estimator.DNNClassifier</code></a> in
...
The first line of the `model_fn` calls <a href="../api_docs/python/tf/feature_column/input_layer.md"><code>tf.feature_column.input_layer</code></a> to
...
we're simply going to call <a href="../api_docs/python/tf/layers/dense.md"><code>tf.layers.dense</code></a> to create hidden layers, with
...
<a href="../api_docs/python/tf/layers/dense.md"><code>tf.layers.dense</code></a> creates a new layer, which takes the previous layer's output
...
Note that <a href="../api_docs/python/tf/layers/dense.md"><code>tf.layers.dense</code></a> provides many additional capabilities, including
...
We'll define the output layer by calling <a href="../api_docs/python/tf/layers/dense.md"><code>tf.layers.dense</code></a> yet again, this
...
<a href="../api_docs/python/tf/nn/softmax.md"><code>tf.nn.softmax</code></a> function.
...
|:---------------------------------|:------------------|
|<a href="../api_docs/python/tf/estimator/BaselineClassifier.md#train"><code>tf.estimator.Estimator.train</code></a> |<a href="../api_docs/python/tf/estimator/ModeKeys.md#TRAIN"><code>tf.estimator.ModeKeys.TRAIN</code></a> |
|<a href="../api_docs/python/tf/estimator/BaselineClassifier.md#evaluate"><code>tf.estimator.Estimator.evaluate</code></a>  |<a href="../api_docs/python/tf/estimator/ModeKeys.md#EVAL"><code>tf.estimator.ModeKeys.EVAL</code></a>      |
|<a href="../api_docs/python/tf/estimator/BaselineClassifier.md#predict"><code>tf.estimator.Estimator.predict</code></a>|<a href="../api_docs/python/tf/estimator/ModeKeys.md#PREDICT"><code>tf.estimator.ModeKeys.PREDICT</code></a> |
...
<a href="../api_docs/python/tf/estimator/EstimatorSpec.md"><code>tf.estimator.EstimatorSpec</code></a>, which contains the information the caller
...
<a href="../api_docs/python/tf/estimator/EstimatorSpec.md"><code>tf.estimator.EstimatorSpec</code></a> containing the prediction.
...
<a href="../api_docs/python/tf/estimator/EstimatorSpec.md"><code>tf.estimator.EstimatorSpec</code></a>. The Estimator's
<a href="../api_docs/python/tf/estimator/BaselineClassifier.md#predict"><code>tf.estimator.Estimator.predict</code></a> method will yield these
dictionaries.
...
We can calculate the loss by calling <a href="../api_docs/python/tf/losses/sparse_softmax_cross_entropy.md"><code>tf.losses.sparse_softmax_cross_entropy</code></a>.
...
<a href="../api_docs/python/tf/estimator/EstimatorSpec.md"><code>tf.estimator.EstimatorSpec</code></a> containing the model's loss and optionally one
or more metrics.

Although returning metrics is optional, most custom Estimators do return at
least one metric. TensorFlow provides a Metrics module <a href="../api_docs/python/tf/metrics.md"><code>tf.metrics</code></a> to
calculate common metrics.  For brevity's sake, we'll only return accuracy. The
<a href="../api_docs/python/tf/metrics/accuracy.md"><code>tf.metrics.accuracy</code></a> function compares our predictions against the
true values, that is, against the labels provided by the input function. The
<a href="../api_docs/python/tf/metrics/accuracy.md"><code>tf.metrics.accuracy</code></a> function requires the labels and predictions to have the
same shape. Here's the call to <a href="../api_docs/python/tf/metrics/accuracy.md"><code>tf.metrics.accuracy</code></a>:
...
The <a href="../api_docs/python/tf/estimator/EstimatorSpec.md"><code>tf.estimator.EstimatorSpec</code></a> returned for evaluation
...
argument of <a href="../api_docs/python/tf/estimator/EstimatorSpec.md"><code>tf.estimator.EstimatorSpec</code></a>. Here's the code:
...
The <a href="../api_docs/python/tf/summary/scalar.md"><code>tf.summary.scalar</code></a> will make accuracy available to TensorBoard
...
<a href="../api_docs/python/tf/train/AdagradOptimizer.md"><code>tf.train.AdagradOptimizer</code></a> because we're mimicking the `DNNClassifier`, which
also uses `Adagrad` by default. The <a href="../api_docs/python/tf/train.md"><code>tf.train</code></a> package provides many other
...
<a href="../api_docs/python/tf/train/Optimizer.md#minimize"><code>tf.train.Optimizer.minimize</code></a> method on the loss we calculated
earlier.
...
<a href="../api_docs/python/tf/train/get_global_step.md"><code>tf.train.get_global_step</code></a> and pass the result to the `global_step`
...
The <a href="../api_docs/python/tf/estimator/EstimatorSpec.md"><code>tf.estimator.EstimatorSpec</code></a> returned for training
