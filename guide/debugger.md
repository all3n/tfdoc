...
<a href="../api_docs/python/tfdbg.md"><code>tfdbg</code></a> is a specialized debugger for TensorFlow. It lets you view the internal
...
This guide focuses on the command-line interface (CLI) of <a href="../api_docs/python/tfdbg.md"><code>tfdbg</code></a>. For guide on
...
with higher-level APIs of TensorFlow, including <a href="../api_docs/python/tf/estimator.md"><code>tf.estimator</code></a>,
<a href="../api_docs/python/tf/keras.md"><code>tf.keras</code></a> / `keras` and <a href="../api_docs/python/tf/contrib/slim.md"><code>tf.contrib.slim</code></a>.
...
Note: You can also write your own custom filters. See <a href="../api_docs/python/tfdbg/DebugDumpDir.md#find"><code>tfdbg.DebugDumpDir.find</code></a>
...
debug them by using special `hook`s provided by <a href="../api_docs/python/tfdbg.md"><code>tfdbg</code></a>.

<a href="../api_docs/python/tfdbg.md"><code>tfdbg</code></a> can debug the
<a href="../api_docs/python/tf/estimator/BaselineClassifier.md#train"><code>tf.estimator.Estimator.train</code></a>,
<a href="../api_docs/python/tf/estimator/BaselineClassifier.md#evaluate"><code>tf.estimator.Estimator.evaluate</code></a> and
<a href="../api_docs/python/tf/estimator/BaselineClassifier.md#predict"><code>tf.estimator.Estimator.predict</code></a>
...
<a href="../api_docs/python/tfdbg/DumpingDebugWrapperSession.md#__init__"><code>tfdbg.DumpingDebugWrapperSession.__init__</code></a>
for more details.
...
TensorFlow backend. You just need to replace <a href="../api_docs/python/tf/keras/backend.md"><code>tf.keras.backend</code></a> with
`keras.backend`.
...
the `offline_analyzer` binary of <a href="../api_docs/python/tfdbg.md"><code>tfdbg</code></a> (described below). It operates on
...
If you interact directly with the <a href="../api_docs/python/tf/Session.md"><code>tf.Session</code></a> API in `python`, you can
configure the `RunOptions` proto that you call your `Session.run()` method
with, by using the method <a href="../api_docs/python/tfdbg/watch_graph.md"><code>tfdbg.watch_graph</code></a>.
...
storage by using the `offline_analyzer` binary of <a href="../api_docs/python/tfdbg.md"><code>tfdbg</code></a>. For example:
...
*   many <a href="../api_docs/python/tf/while_loop.md"><code>tf.while_loop</code></a> iterations
...
```
   ...
   <a href="../api_docs/python/tfdbg.md"><code>tfdbg</code></a> cleans up the dump directories before exiting.
...
**A**: The reason why you see no data dumped is because every node in the
       ...
       node to speed up future runs of the graph, which is why <a href="../api_docs/python/tfdbg.md"><code>tfdbg</code></a> does
       not generate any intermediate tensor dumps. However, if `a` were a
       <a href="../api_docs/python/tf/Variable.md"><code>tf.Variable</code></a>, as in the following example:
...
the constant-folding would not occur and <a href="../api_docs/python/tfdbg.md"><code>tfdbg</code></a> should show the intermediate
tensor dumps.
